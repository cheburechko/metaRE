...
context("MotifPositionsSparse") {
    test_that("initialization works") {
        ...
        MotifPositionsSparse data(labelGenerator, geneLabels);
        ...
        test_that("structure getters work") {
            ...
            expect_true(structure.at(0).size() == 4);
            expect_true(structure.at(0)[0] == 0);
            expect_true(structure.at(0)[1] == 1);
            expect_true(structure.at(0)[2] == 2);
            expect_true(structure.at(0)[3] == 0);

            expect_true(structure.at(1).size() == 3);
            expect_true(structure.at(1)[0] == 0);
            expect_true(structure.at(1)[1] == 2);
            expect_true(structure.at(1)[2] == 0);
